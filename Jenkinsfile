    ...
    stages {
        stage('Stage 1: Build') {
            steps {
                ...
                echo 'updating this jenkins file'
            }
        }
        ...
        stage('Stage 2: Unit and Integration Tests') {
            ...
            post {
                success {
                    emailext attachLog: true, body: "Stage 2: Unit and Integration Tests passed successfully.", subject: "Pipeline Notification: Stage 2 Passed", to: "azeem4773.be22@chitkara.edu.in"
                }
                failure {
                    emailext attachLog: true, body: "Stage 2: Unit and Integration Tests failed. Please check the logs for details.", subject: "Pipeline Notification: Stage 2 Failed", to: "azeem4773.be22@chitkara.edu.in"
                }
            }
        }
        ...
        stage('Stage 4: Security Scan') {
            ...
            post {
                success {
                    emailext attachLog: true, body: "Stage 4: Security Scan passed successfully.", subject: "Pipeline Notification: Stage 4 Passed", to: "azeem4773.be22@chitkara.edu.in"
                }
                failure {
                    emailext attachLog: true, body: "Stage 4: Security Scan failed. Please check the logs for details.", subject: "Pipeline Notification: Stage 4 Failed", to: "azeem4773.be22@chitkara.edu.in"
                }
            }
        }
